...
STATEFUL_PROMPT_VERSION = "stateful-v1.1"
...
For numeric-boundary attacks, exercise both zero and a negative value. Assert every invalid response is HTTP 422, then prove invalid input did not change stock or create an order or provider charge. Do not substitute a single boundary example or status-only evidence."""
